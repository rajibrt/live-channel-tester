...
const COPY = {
  en: {
    ...
    noticeBody: "WEBTVBD does not host or upload the live TV streams or video sources presented through the site. The platform acts as an organized directory and browsing layer for links that may originate from public or third-party sources.",
  ...
  bn: {
    ...
    noticeBody: "WEBTVBD সাইটে দেখানো লাইভ টিভি স্ট্রিম বা ভিডিও সোর্স হোস্ট বা আপলোড করে না। প্ল্যাটফর্মটি পাবলিক বা থার্ড-পার্টি সোর্স থেকে আসা লিংকের জন্য একটি organized directory ও browsing layer হিসেবে কাজ করে।",
    service: "সেবার পরিধি",
